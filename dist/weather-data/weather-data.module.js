...
const weather_data_controller_1 = require("./weather-data.controller");
let WeatherDataModule = class WeatherDataModule {
};
exports.WeatherDataModule = WeatherDataModule;
exports.WeatherDataModule = WeatherDataModule = __decorate([
    (0, common_1.Module)({
        controllers: [weather_data_controller_1.WeatherDataController],
        providers: [weather_data_service_1.WeatherDataService],
    })
], WeatherDataModule);
//# sourceMappingURL=weather-data.module.js.map